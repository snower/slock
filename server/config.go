...
const QUEUE_MAX_MALLOC_SIZE = 0x3ffffff

const TIMEOUT_QUEUE_LENGTH int64 = 0x10
const EXPRIED_QUEUE_LENGTH int64 = 0x10
const WAIT_REMOVE_LOCK_MANAGER_QUEUE_LENGTH = 0x04
...
const MANAGER_MAX_GLOCKS_INIT_SIZE = 131072
const TIMEOUT_LOCKS_QUEUE_INIT_SIZE = 4096
const EXPRIED_LOCKS_QUEUE_INIT_SIZE = 4096
const WAIT_REMOVE_LOCK_MANAGER_INIT_SIZE = 512
...
const FREE_MILLISECOND_WAIT_QUEUE_INIT_SIZE = 4096
const FREE_COMMAND_MAX_SIZE = 64
